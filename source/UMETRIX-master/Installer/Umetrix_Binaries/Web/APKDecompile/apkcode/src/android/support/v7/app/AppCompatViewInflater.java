...
class AppCompatViewInflater
{
  ...
  private static final Map d = new ArrayMap();
  ...
  private static Context a(Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (int i = paramAttributeSet.getResourceId(R.styleable.View_android_theme, 0);; i = 0)
    {
      ...
      if (j != 0) {
        ...
        {
          paramAttributeSet = paramContext;
          if (((ContextThemeWrapper)paramContext).a() == j) {}
        }
        else
        {
  ...
  private View a(Context paramContext, String paramString, AttributeSet paramAttributeSet)
  {
    ...
    //   21: astore 5
    //   23: aload_0
    //   24: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   27: iconst_0
    //   28: aload_1
    //   29: aastore
    //   30: aload_0
    //   31: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   34: iconst_1
    //   35: aload_3
    //   36: aastore
    //   37: iconst_m1
    ...
    //   49: istore 4
    //   51: iload 4
    //   53: getstatic 37	android/support/v7/app/AppCompatViewInflater:c	[Ljava/lang/String;
    //   56: arraylength
    //   57: if_icmpge +46 -> 103
    //   60: aload_0
    //   61: aload_1
    //   62: aload 5
    //   64: getstatic 37	android/support/v7/app/AppCompatViewInflater:c	[Ljava/lang/String;
    //   67: iload 4
    //   69: aaload
    //   70: invokespecial 114	android/support/v7/app/AppCompatViewInflater:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   73: astore_2
    //   74: aload_2
    //   75: ifnull +19 -> 94
    //   78: aload_0
    //   79: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   82: iconst_0
    //   83: aconst_null
    //   84: aastore
    //   85: aload_0
    //   86: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   89: iconst_1
    //   90: aconst_null
    //   91: aastore
    //   92: aload_2
    ...
    //   100: goto -49 -> 51
    //   103: aload_0
    //   104: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   107: iconst_0
    //   108: aconst_null
    //   109: aastore
    //   110: aload_0
    //   111: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   114: iconst_1
    //   115: aconst_null
    //   116: aastore
    //   117: aconst_null
    ...
    //   121: aload 5
    //   123: aconst_null
    //   124: invokespecial 114	android/support/v7/app/AppCompatViewInflater:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   127: astore_1
    //   128: aload_0
    //   129: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   132: iconst_0
    //   133: aconst_null
    //   134: aastore
    //   135: aload_0
    //   136: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   139: iconst_1
    //   140: aconst_null
    //   141: aastore
    //   142: aload_1
    ...
    //   144: astore_1
    //   145: aload_0
    //   146: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   149: iconst_0
    //   150: aconst_null
    //   151: aastore
    //   152: aload_0
    //   153: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   156: iconst_1
    //   157: aconst_null
    //   158: aastore
    //   159: aconst_null
    ...
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   166: iconst_0
    //   167: aconst_null
    //   168: aastore
    //   169: aload_0
    //   170: getfield 48	android/support/v7/app/AppCompatViewInflater:e	[Ljava/lang/Object;
    //   173: iconst_1
    //   174: aconst_null
    //   175: aastore
    //   176: aload_1
  ...
  private void a(View paramView, AttributeSet paramAttributeSet)
  {
    ...
    if ((!(localObject instanceof ContextWrapper)) || ((Build.VERSION.SDK_INT >= 15) && (!ViewCompat.w(paramView)))) {
      return;
    }
  ...
  public final View a(View paramView, String paramString, Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    for (Object localObject = paramView.getContext();; localObject = paramContext)
    {
      ...
      if (paramBoolean4) {
        localObject = TintContextWrapper.a(paramView);
      }
      paramView = null;
      int i = -1;
