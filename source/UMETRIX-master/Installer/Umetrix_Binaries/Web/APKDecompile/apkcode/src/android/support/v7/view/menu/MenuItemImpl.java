  ...
  implements SupportMenuItem
{
  ...
  public SupportMenuItem a(android.support.v4.view.ActionProvider paramActionProvider)
  {
    if (this.s != null) {
      this.s.f();
    }
    ...
    this.l.b(true);
    if (this.s != null) {
      this.s.a(new MenuItemImpl.1(this));
    }
    return this;
  }
  
  public SupportMenuItem a(MenuItemCompat.OnActionExpandListener paramOnActionExpandListener)
  {
  ...
  public void a(SubMenuBuilder paramSubMenuBuilder)
  {
  ...
  public Drawable getIcon()
  {
    ...
    if (this.k != 0)
    {
      Drawable localDrawable = AppCompatDrawableManager.a().a(this.l.e(), this.k);
      this.k = 0;
