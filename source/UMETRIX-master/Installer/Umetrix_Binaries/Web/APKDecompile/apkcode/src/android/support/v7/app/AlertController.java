...
class AlertController
{
  ...
  private int L = 0;
  private Handler M;
  private final View.OnClickListener N = new AlertController.1(this);
  ...
  public AlertController(Context paramContext, AppCompatDialog paramAppCompatDialog, Window paramWindow)
  {
    ...
    this.c = paramWindow;
    this.M = new AlertController.ButtonHandler(paramAppCompatDialog);
  ...
  private void a(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    ...
    View localView2 = this.c.findViewById(R.id.scrollIndicatorUp);
    View localView1 = this.c.findViewById(R.id.scrollIndicatorDown);
    if (Build.VERSION.SDK_INT >= 23)
    {
      ViewCompat.a(paramView, paramInt1, paramInt2);
      if (localView2 != null) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.e != null)
        {
          this.w.setOnScrollChangeListener(new AlertController.2(this, paramView, (View)localObject));
          this.w.post(new AlertController.3(this, paramView, (View)localObject));
          return;
        }
        if (this.f != null)
        {
          this.f.setOnScrollListener(new AlertController.4(this, paramView, (View)localObject));
          this.f.post(new AlertController.5(this, paramView, (View)localObject));
          return;
        }
        if (paramView != null) {
  ...
  private void c()
  {
    Object localObject2 = this.c.findViewById(R.id.parentPanel);
  ...
  {
    this.w = ((NestedScrollView)this.c.findViewById(R.id.scrollView));
