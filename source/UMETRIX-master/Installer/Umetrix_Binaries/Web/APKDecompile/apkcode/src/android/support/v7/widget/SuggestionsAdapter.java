  ...
  implements View.OnClickListener
{
  ...
  private Drawable a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localDrawable == null)
        {
          localObject1 = ContextCompat.a(this.m, i);
  ...
  private CharSequence b(CharSequence paramCharSequence)
  {
    if (this.r == null)
    {
      ...
      this.d.getTheme().resolveAttribute(R.attr.textColorSearchUrl, (TypedValue)localObject, true);
  ...
  public View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    ((ImageView)paramContext.findViewById(R.id.edit_query)).setImageResource(this.o);
    return paramContext;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    catch (RuntimeException paramView)
    {
      ...
      if (paramViewGroup != null) {
        ((SuggestionsAdapter.ChildViewCache)paramViewGroup.getTag()).a.setText(paramView.toString());
      }
    }
