...
{
  private static final NestedScrollView.AccessibilityDelegate v = new NestedScrollView.AccessibilityDelegate();
  ...
  private View a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      break label87;
      label115:
      if (((paramBoolean) && (i4 < localObject2.getTop())) || ((!paramBoolean) && (i6 > localObject2.getBottom()))) {}
      for (i4 = 1;; i4 = 0)
      {
        if (i1 == 0) {
          break label170;
  ...
  private void a()
  {
    this.c = ScrollerCompat.a(getContext(), null);
    setFocusable(true);
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    for (i1 = 1;; i1 = 0)
    {
      this.f = ((int)MotionEventCompat.d(paramMotionEvent, i1));
  ...
  private void g()
  {
    if (ViewCompat.a(this) != 2)
    {
      if (this.d == null)
      {
        ...
        this.d = new EdgeEffectCompat(localContext);
        this.e = new EdgeEffectCompat(localContext);
      }
      return;
    }
    this.d = null;
  ...
  {
    if ((MotionEventCompat.d(paramMotionEvent) & 0x2) != 0) {
    ...
    for (;;)
    {
      ...
      if (!this.j)
      {
        float f1 = MotionEventCompat.e(paramMotionEvent, 9);
        if (f1 != 0.0F)
        {
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i1 != -1)
      {
        int i2 = MotionEventCompat.a(paramMotionEvent, i1);
        if (i2 == -1)
        {
        ...
        {
          i1 = (int)MotionEventCompat.d(paramMotionEvent, i2);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      for (;;)
      {
        ...
        i3 = MotionEventCompat.a(paramMotionEvent, this.q);
        if (i3 != -1) {
          break;
        }
        Log.e("NestedScrollView", "Invalid pointerId=" + this.q + " in onTouchEvent");
      }
      i4 = (int)MotionEventCompat.d(paramMotionEvent, i3);
      i2 = this.f - i4;
      i1 = i2;
    ...
    while (this.j)
    {
      ...
      if (i2 < 0)
      {
        this.d.a(i1 / getHeight(), MotionEventCompat.c(paramMotionEvent, i3) / getWidth());
        if (!this.e.a()) {
          this.e.c();
        }
      }
      while ((this.d != null) && ((!this.d.a()) || (!this.e.a())))
      {
        ...
        if (i2 > i4)
        {
          this.e.a(i1 / getHeight(), 1.0F - MotionEventCompat.c(paramMotionEvent, i3) / getWidth());
          if (!this.d.a()) {
            this.d.c();
          }
        }
      ...
      if (this.j)
      {
        ...
        i1 = (int)VelocityTrackerCompat.b(paramMotionEvent, this.q);
      ...
      break;
      a(paramMotionEvent);
      this.f = ((int)MotionEventCompat.d(paramMotionEvent, MotionEventCompat.a(paramMotionEvent, this.q)));
      break;
    }
  }
