...
{
  private AnimatedVectorDrawableCompat.AnimatedVectorDrawableCompatState b;
  private Context c;
  private ArgbEvaluator d = null;
  private final Drawable.Callback e = new AnimatedVectorDrawableCompat.1(this);
  ...
  private AnimatedVectorDrawableCompat(Context paramContext, AnimatedVectorDrawableCompat.AnimatedVectorDrawableCompatState paramAnimatedVectorDrawableCompatState, Resources paramResources)
  {
    this.c = paramContext;
    if (paramAnimatedVectorDrawableCompatState != null)
    {
      this.b = paramAnimatedVectorDrawableCompatState;
      return;
    }
    this.b = new AnimatedVectorDrawableCompat.AnimatedVectorDrawableCompatState(paramContext, paramAnimatedVectorDrawableCompatState, this.e, paramResources);
  }
  ...
  public static AnimatedVectorDrawableCompat a(Context paramContext, Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
  ...
  {
    if (this.a != null) {
      DrawableCompat.a(this.a, paramTheme);
    }
  }
  ...
  {
    if (this.a != null) {
      return DrawableCompat.d(this.a);
    }
    return false;
  }
  ...
  {
    if (this.a != null) {
      return new AnimatedVectorDrawableCompat.AnimatedVectorDrawableDelegateState(this.a.getConstantState());
    }
    return null;
  }
  ...
  public void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        localObject1 = a(paramResources, paramTheme, paramAttributeSet, AndroidResources.e);
        i = ((TypedArray)localObject1).getResourceId(0, 0);
        if (i != 0)
        {
          localObject2 = VectorDrawableCompat.a(paramResources, i, paramTheme);
          ((VectorDrawableCompat)localObject2).a(false);
          ((VectorDrawableCompat)localObject2).setCallback(this.e);
          if (this.b.b != null) {
            this.b.b.setCallback(null);
          }
          this.b.b = ((VectorDrawableCompat)localObject2);
        }
    ...
    for (;;)
    {
      ...
      {
        localObject1 = paramResources.obtainAttributes(paramAttributeSet, AndroidResources.f);
