...
{
  private static final AccessibilityNodeInfoCompat.AccessibilityNodeInfoImpl a = new AccessibilityNodeInfoCompat.AccessibilityNodeInfoStubImpl();
  ...
  static
  {
    ...
    {
      a = new AccessibilityNodeInfoCompat.AccessibilityNodeInfoApi22Impl();
      return;
    }
    if (Build.VERSION.SDK_INT >= 21)
    {
      a = new AccessibilityNodeInfoCompat.AccessibilityNodeInfoApi21Impl();
      return;
    }
    if (Build.VERSION.SDK_INT >= 19)
    {
      a = new AccessibilityNodeInfoCompat.AccessibilityNodeInfoKitKatImpl();
      return;
    }
    if (Build.VERSION.SDK_INT >= 18)
    {
      a = new AccessibilityNodeInfoCompat.AccessibilityNodeInfoJellybeanMr2Impl();
      return;
    }
    if (Build.VERSION.SDK_INT >= 17)
    {
      a = new AccessibilityNodeInfoCompat.AccessibilityNodeInfoJellybeanMr1Impl();
      return;
    }
  ...
  public boolean a(AccessibilityNodeInfoCompat.AccessibilityActionCompat paramAccessibilityActionCompat)
  {
    return a.a(this.b, AccessibilityNodeInfoCompat.AccessibilityActionCompat.a(paramAccessibilityActionCompat));
  }
