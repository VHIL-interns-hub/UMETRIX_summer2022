  ...
  implements MenuView.ItemView
{
  ...
  public ListMenuItemView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.g = paramAttributeSet.getDrawable(R.styleable.MenuView_android_itemBackground);
    this.h = paramAttributeSet.getResourceId(R.styleable.MenuView_android_itemTextAppearance, -1);
    this.j = paramAttributeSet.getBoolean(R.styleable.MenuView_preserveIconSpacing, false);
    this.i = paramContext;
  ...
  public void a(MenuItemImpl paramMenuItemImpl, int paramInt)
  {
    ...
    for (paramInt = 0;; paramInt = 8)
    {
      ...
      a(paramMenuItemImpl.f(), paramMenuItemImpl.d());
