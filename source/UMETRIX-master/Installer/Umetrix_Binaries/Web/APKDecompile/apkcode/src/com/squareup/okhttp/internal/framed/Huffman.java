...
class Huffman
{
  ...
  private void a(int paramInt1, int paramInt2, byte paramByte)
  {
    ...
    for (Huffman.Node localNode1 = this.d; paramByte > 8; localNode1 = Huffman.Node.a(localNode1)[paramInt1])
    {
      paramByte = (byte)(paramByte - 8);
      paramInt1 = paramInt2 >>> paramByte & 0xFF;
      if (Huffman.Node.a(localNode1) == null) {
        throw new IllegalStateException("invalid dictionary: prefix not unique");
      }
      if (Huffman.Node.a(localNode1)[paramInt1] == null) {
        Huffman.Node.a(localNode1)[paramInt1] = new Huffman.Node();
      }
    }
    ...
    {
      Huffman.Node.a(localNode1)[paramInt1] = localNode2;
      paramInt1 += 1;
    }
  }
  ...
  byte[] a(byte[] paramArrayOfByte)
  {
    ...
    Huffman.Node localNode1 = this.d;
    int k = 0;
    int i = 0;
    int m;
    ...
    for (;;)
    {
      ...
      while (i >= 8)
      {
        localNode1 = Huffman.Node.a(localNode1)[(k >>> i - 8 & 0xFF)];
        if (Huffman.Node.a(localNode1) == null)
        {
          localByteArrayOutputStream.write(Huffman.Node.b(localNode1));
          i -= Huffman.Node.c(localNode1);
          localNode1 = this.d;
        }
        else
        {
    ...
    do
    {
      localByteArrayOutputStream.write(Huffman.Node.b(paramArrayOfByte));
      m -= Huffman.Node.c(paramArrayOfByte);
      localNode2 = this.d;
      if (m <= 0) {
        break;
      }
      paramArrayOfByte = Huffman.Node.a(localNode2)[(k << 8 - m & 0xFF)];
    } while ((Huffman.Node.a(paramArrayOfByte) == null) && (Huffman.Node.c(paramArrayOfByte) <= m));
