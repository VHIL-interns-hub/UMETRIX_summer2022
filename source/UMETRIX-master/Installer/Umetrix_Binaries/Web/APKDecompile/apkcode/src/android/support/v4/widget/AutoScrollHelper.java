  ...
  implements View.OnTouchListener
{
  ...
  private final AutoScrollHelper.ClampedScroller a = new AutoScrollHelper.ClampedScroller();
  ...
  private boolean a()
  {
    AutoScrollHelper.ClampedScroller localClampedScroller = this.a;
    int i1 = localClampedScroller.f();
    int i2 = localClampedScroller.e();
  ...
  {
    if (this.d == null) {
      this.d = new AutoScrollHelper.ScrollAnimationRunnable(this, null);
    }
    this.o = true;
    this.m = true;
    if ((!this.l) && (this.h > 0)) {
      ViewCompat.a(this.c, this.d, this.h);
    }
    for (;;)
    {
      this.l = true;
  ...
  public AutoScrollHelper a(float paramFloat1, float paramFloat2)
  {
  ...
  public AutoScrollHelper a(int paramInt)
  {
    this.g = paramInt;
    return this;
  }
  
  public AutoScrollHelper a(boolean paramBoolean)
  {
  ...
  public AutoScrollHelper b(float paramFloat1, float paramFloat2)
  {
  ...
  public AutoScrollHelper b(int paramInt)
  {
    this.h = paramInt;
    return this;
  }
  
  public AutoScrollHelper c(float paramFloat1, float paramFloat2)
  {
  ...
  public AutoScrollHelper c(int paramInt)
  {
    this.a.a(paramInt);
    return this;
  }
  
  public AutoScrollHelper d(float paramFloat1, float paramFloat2)
  {
  ...
  public AutoScrollHelper d(int paramInt)
  {
    this.a.b(paramInt);
    return this;
  }
  
  public AutoScrollHelper e(float paramFloat1, float paramFloat2)
  {
