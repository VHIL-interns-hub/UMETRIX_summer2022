...
{
  private static final BakedBezierInterpolator a = new BakedBezierInterpolator();
  ...
  public static BakedBezierInterpolator a()
  {
    return a;
  }
  ...
  public float getInterpolation(float paramFloat)
  {
    ...
    int i = Math.min((int)((b.length - 1) * paramFloat), b.length - 2);
    paramFloat = (paramFloat - i * c) / c;
    float f = b[i];
    return (b[(i + 1)] - b[i]) * paramFloat + f;
  }
}
