  ...
  extends AbsActionBarView
{
  ...
  public ActionBarContextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = TintTypedArray.a(paramContext, paramAttributeSet, R.styleable.ActionMode, paramInt, 0);
    setBackgroundDrawable(paramContext.a(R.styleable.ActionMode_background));
    this.n = paramContext.g(R.styleable.ActionMode_titleTextStyle, 0);
    this.o = paramContext.g(R.styleable.ActionMode_subtitleTextStyle, 0);
    this.e = paramContext.f(R.styleable.ActionMode_height, 0);
    this.q = paramContext.g(R.styleable.ActionMode_closeItemLayout, R.layout.abc_action_mode_close_item_material);
    paramContext.a();
  }
  ...
  public void a(ActionMode paramActionMode)
  {
    ...
    for (;;)
    {
      this.i.findViewById(R.id.action_mode_close_button).setOnClickListener(new ActionBarContextView.1(this, paramActionMode));
      paramActionMode = (MenuBuilder)paramActionMode.b();
      if (this.d != null) {
        this.d.f();
      }
      ...
      paramActionMode.a(this.d, this.b);
