...
{
  static final ViewParentCompat.ViewParentCompatImpl a = new ViewParentCompat.ViewParentCompatStubImpl();
  ...
  static
  {
    ...
    if (i >= 21)
    {
      a = new ViewParentCompat.ViewParentCompatLollipopImpl();
      return;
    }
    if (i >= 19)
    {
      a = new ViewParentCompat.ViewParentCompatKitKatImpl();
      return;
    }
    if (i >= 14)
    {
      a = new ViewParentCompat.ViewParentCompatICSImpl();
      return;
    }
  }
