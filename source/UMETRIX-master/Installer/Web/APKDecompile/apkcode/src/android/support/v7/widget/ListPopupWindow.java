...
public class ListPopupWindow
{
  ...
  private final ListPopupWindow.ListSelectorHider A = new ListPopupWindow.ListSelectorHider(this, null);
  private Runnable B;
  ...
  private ListPopupWindow.DropDownListView g;
  private int h = -2;
  private int i = -2;
  private int j;
  private int k;
  ...
  private final ListPopupWindow.ResizePopupRunnable x = new ListPopupWindow.ResizePopupRunnable(this, null);
  private final ListPopupWindow.PopupTouchInterceptor y = new ListPopupWindow.PopupTouchInterceptor(this, null);
  private final ListPopupWindow.PopupScrollListener z = new ListPopupWindow.PopupScrollListener(this, null);
  ...
  private int b()
  {
    ...
    {
      localObject2 = this.d;
      this.B = new ListPopupWindow.2(this);
      if (!this.E)
      {
        bool1 = true;
        this.g = new ListPopupWindow.DropDownListView((Context)localObject2, bool1);
        if (this.u != null) {
  ...
  {
    if (this.s == null) {
      this.s = new ListPopupWindow.PopupDataSetObserver(this, null);
    }
    for (;;)
    {
  ...
  {
    ListPopupWindow.DropDownListView localDropDownListView = this.g;
