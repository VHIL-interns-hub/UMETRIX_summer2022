  ...
  extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      this.a = paramContext.getDrawable(R.styleable.ActionBar_background);
      this.b = paramContext.getDrawable(R.styleable.ActionBar_backgroundStacked);
      this.j = paramContext.getDimensionPixelSize(R.styleable.ActionBar_height, -1);
      if (getId() == R.id.split_action_bar)
      {
        this.d = true;
        this.c = paramContext.getDrawable(R.styleable.ActionBar_backgroundSplit);
      }
