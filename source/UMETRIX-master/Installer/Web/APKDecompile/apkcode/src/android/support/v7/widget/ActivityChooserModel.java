  ...
  extends DataSetObservable
{
  ...
  private Intent i;
  private ActivityChooserModel.ActivitySorter j;
  private int k;
  private boolean l;
  private boolean m;
  private boolean n;
  ...
  private void d()
  {
    ...
    AsyncTaskCompat.a(new ActivityChooserModel.PersistHistoryAsyncTask(this, null), new Object[] { new ArrayList(this.f), this.h });
  }
  ...
  private void i()
  {
    ...
    for (;;)
    {
      ...
      while (i1 < i2)
      {
        ActivityChooserModel.HistoricalRecord localHistoricalRecord = (ActivityChooserModel.HistoricalRecord)this.f.remove(0);
        i1 += 1;
      }
    }
  }
  ...
  private void j()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 56	android/support/v7/widget/ActivityChooserModel:g	Landroid/content/Context;
    //   4: aload_0
    //   5: getfield 83	android/support/v7/widget/ActivityChooserModel:h	Ljava/lang/String;
    ...
    //   70: athrow
    //   71: astore_3
    //   72: getstatic 40	android/support/v7/widget/ActivityChooserModel:a	Ljava/lang/String;
    ...
    //   87: aload_0
    //   88: getfield 83	android/support/v7/widget/ActivityChooserModel:h	Ljava/lang/String;
    ...
    //   110: return
    //   111: aload_0
    //   112: getfield 59	android/support/v7/widget/ActivityChooserModel:f	Ljava/util/List;
    //   115: astore 4
    //   117: aload 4
    ...
    //   180: athrow
    //   181: astore_3
    //   182: getstatic 40	android/support/v7/widget/ActivityChooserModel:a	Ljava/lang/String;
    ...
    //   197: aload_0
    //   198: getfield 83	android/support/v7/widget/ActivityChooserModel:h	Ljava/lang/String;
    ...
    //   222: return
    //   223: aload 4
    //   225: new 177	android/support/v7/widget/ActivityChooserModel$HistoricalRecord
    //   228: dup
    //   229: aload_3
    //   230: aconst_null
    //   231: ldc -11
    ...
    //   263: invokespecial 268	android/support/v7/widget/ActivityChooserModel$HistoricalRecord:<init>	(Ljava/lang/String;JF)V
  ...
  public int a(ResolveInfo paramResolveInfo)
  {
    for (;;)
    {
      ...
      synchronized (this.d)
      {
        ...
        if (i1 < i2)
        {
          if (((ActivityChooserModel.ActivityResolveInfo)localList.get(i1)).a == paramResolveInfo) {
            return i1;
          }
        }
        else {
  ...
  public Intent b(int paramInt)
  {
    synchronized (this.d)
    {
      ...
      e();
      Object localObject2 = (ActivityChooserModel.ActivityResolveInfo)this.e.get(paramInt);
      localObject2 = new ComponentName(((ActivityChooserModel.ActivityResolveInfo)localObject2).a.activityInfo.packageName, ((ActivityChooserModel.ActivityResolveInfo)localObject2).a.activityInfo.name);
      ...
      a(new ActivityChooserModel.HistoricalRecord((ComponentName)localObject2, System.currentTimeMillis(), 1.0F));
      return localIntent1;
    }
  }
