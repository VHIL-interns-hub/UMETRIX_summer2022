  ...
  extends MenuInflater
{
      ...
      for (;;)
      {
        ...
        if (i == 0)
        {
          ...
          else
          {
            ...
            {
              if (!localMenuState.d()) {
                if ((SupportMenuInflater.MenuState.a(localMenuState) != null) && (SupportMenuInflater.MenuState.a(localMenuState).e())) {
                  localMenuState.c();
                } else {
                  localMenuState.b();
                }
  ...
  public void inflate(int paramInt, Menu paramMenu)
  {
    ...
    //   20: astore 4
    //   22: aload_0
    //   23: getfield 31	android/support/v7/view/SupportMenuInflater:e	Landroid/content/Context;
    ...
    //   54: aload_2
    //   55: invokespecial 108	android/support/v7/view/SupportMenuInflater:a	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    //   58: aload 6
    //   60: ifnull -47 -> 13
    //   63: aload 6
